...
model = load_model('predictor_PEA3_9800_1_sell_weight.h5')
model.summary()
...
with open('product/PEA3_9800_1.csv', 'r', encoding='cp949', newline='') as file:
    rdr = csv.reader(file)
    file.readline()
    for line in rdr:
        line = ''.join(line)
...
# # 파일 Data 추가
# with open('account_day_total.csv', 'a', encoding='cp949', newline='') as file:
